# stolen from https://github.com/nakato/nixos-sbc/blob/main/modules/sbc/bootstrap/make-btrfs-fs.nix
...
pkgs.stdenv.mkDerivation {
  ...
  buildCommand =
    ...
    ''
      ...
      touch $img
      faketime -f "1970-01-01 00:00:01" fakeroot mkfs.btrfs -M -O extref,skinny-metadata,no-holes -L ${volumeLabel} -U ${uuid} ${subvolMkfsArgs} -r ./rootImage --shrink $img
