...
pkgs.stdenv.mkDerivation {
  ...
  buildCommand = ''
    ...
    echo "copying squashfs to image..."
    mkdir -p ./rootImage/sysroot
    cp ${squashfs} ./rootImage/sysroot/nix-store.squashfs
    ...
    faketime -f "1970-01-01 00:00:01" fakeroot mkfs.ext4 -L ${volumeLabel} -U ${uuid} -b 1024 -O ^has_journal -O sparse_super -m 1 -d ./rootImage $img
