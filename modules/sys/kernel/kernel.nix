  ...
  let
    ...
    drvAttrs =
      ...
      // {
        ...
        postPatch = ''
          # Ensure that depmod && pwd gets resolved through PATH
          sed -i Makefile -e 's|= /sbin/depmod|= depmod|'
          sed -i Makefile -e 's|/bin/pwd|pwd|'
        ...
        postInstall = optionalString isModular ''
          mkdir -p $out/dtbs
          cp arch/arm64/boot/dts/amlogic/superbird.dtb $out/dtbs/superbird.dtb
    ...
    // {
      ...
      makeFlags =
        [
          ...
          "HOSTLD=${stdenv.cc.bintools}/bin/${stdenv.cc.targetPrefix}ld"
